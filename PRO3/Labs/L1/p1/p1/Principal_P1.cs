using System;
//using es un package
namespace Pregunta1 //todas las clases que estan en namespace pertenecen a ese espacion de nombre
{
    public class Principal 
    {
        static void Main(string[] args)
        {
			...
			//en java -> postulante.setPaterno() el refactor se le dice propiedades
            postulante.Paterno = "Pérez";//esto es una propiedad
            postulante.Materno = "Deza";
            postulante.Nombre = "Juan Alonso";
            postulante.Dni = "75355946B";
            ficha.Candidato = postulante;
            ficha.Fecha_hora = new DateTime(2025, 02, 20, 14, 00, 00); //se encuentra en System
