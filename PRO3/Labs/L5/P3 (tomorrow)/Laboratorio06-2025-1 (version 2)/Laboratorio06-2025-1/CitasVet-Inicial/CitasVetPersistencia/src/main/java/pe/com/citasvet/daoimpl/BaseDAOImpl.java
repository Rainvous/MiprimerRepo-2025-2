...
public abstract class BaseDAOImpl {
    ...
    protected void abrirConexion() throws IOException, SQLException, ClassNotFoundException {
    ...
    protected void iniciarTransaccion() throws SQLException, IOException, ClassNotFoundException {
        this.abrirConexion();
    ...
    protected Integer insertar() throws IOException, ClassNotFoundException {
        return this.ejecuta_DML(Tipo_Operacion.INSERTAR);
    }

    protected Integer modificar() throws IOException, ClassNotFoundException {
        return this.ejecuta_DML(Tipo_Operacion.MODIFICAR);
    }

    protected Integer eliminar() throws IOException, ClassNotFoundException {
        return this.ejecuta_DML(Tipo_Operacion.ELIMINAR);
    }

    private Integer ejecuta_DML(Tipo_Operacion tipo_operacion) throws IOException, ClassNotFoundException {
        Integer resultado = 0;
        try {
    ...
    public Integer retornarUltimoAutoGenerado() throws IOException {
    ...
    public void obtenerPorId() throws IOException, ClassNotFoundException {
        try {
            this.abrirConexion();
    ...
    public List listarTodos() throws IOException, ClassNotFoundException {
        String sql = null;
    ...
    public List listarTodos(String sql,
            ...
            Object parametros) throws IOException, ClassNotFoundException {
    ...
    public void ejecutarProcedimientoAlmacenado(String sql,
            Boolean conTransaccion) throws IOException, ClassNotFoundException {
        Consumer incluirValorDeParametros = null;
        Object parametros = null;
